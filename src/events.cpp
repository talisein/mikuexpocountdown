...
namespace {
    ...
    const std::array raw_events {std::to_array<Miku::raw_event>({
                {"Vancouver"  , "Miku Expo Vancouver", "expo2024", local_days{April/4/2024}  + 20h, 2h, PST},
                ...
                {"DC"         , "Miku Expo DC",        "expo2024", local_days{May/5/2024}    + 20h, 2h, EST},
                ...
                {"Detroit"    , "Miku Expo Detroit",   "expo2024", local_days{May/12/2024}   + 20h, 2h, EST},
                {"Chicago"    , "Miku Expo Chicago",   "expo2024", local_days{May/14/2024}   + 20h, 2h, EST},
